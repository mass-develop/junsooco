package com.maunt.myapplication.Alert;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            if (listItemView == null) {
                listItemView = LayoutInflater.from(getContext()).inflate(R.layout.xalert_listview_oneitem, parent, false);
            }

            TextView textView1 = (TextView) listItemView.findViewById(R.id.aCoinCode);
            TextView textView2 = (TextView) listItemView.findViewById(R.id.aCoinName);
            TextView textView3 = (TextView) listItemView.findViewById(R.id.aHigher);

            TextView textView4 = (TextView) listItemView.findViewById(R.id.aLower);
            TextView textView5 = (TextView) listItemView.findViewById(R.id.anote);
            ...
            ImageButton btnNxt = (ImageButton) listItemView.findViewById(R.id.alertDelete);
