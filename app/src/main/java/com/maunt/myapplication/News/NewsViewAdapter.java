...
public class NewsViewAdapter extends RecyclerView.Adapter<NewsViewAdapter.ListViewHolder> {
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ListViewHolder(View view) {
            ...
            nImageView = (ImageView) view.findViewById(R.id.nImageView);
            nTitle = (TextView) view.findViewById(R.id.nTextViewHeaer);
            nDesc = (TextView) view.findViewById(R.id.nTextViewDesc);
